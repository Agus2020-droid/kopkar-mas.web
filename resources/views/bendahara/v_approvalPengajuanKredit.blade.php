...
@section('content')
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div id="load" class="overlay d-none">
              ...
              <form class="form-horizontal" action="{{route('update.kredit.bendahara')}}" method="post">
                @csrf
                    ...
                    <div class="col-sm-6">
                      <div class="box p-2 m-1" >
                        <div class="form-group row ">
                          ...
                          <div class="col-sm-8">
                            <input id="tanpa-rupiah" name="nominal" type="text" class="form-control" value="@formatUang($data->nominal)" required>
                          </div>
                        </div>
                        <div class="form-group row">
                          <label class="col-sm-4 col-form-label">Tenor<span class="text-red">*</span></label>
                          <div class="col-sm-8">
                              <input id="tenor" name="tenor" type="number" class="form-control" max="<?php if($data->jns_krdt == 'BARANG') echo '12'; elseif($data->jns_krdt == 'KENDARAAN') echo '24'; elseif($data->jns_krdt == 'TUNAI') echo '5'; ?>" value="{{$data->tenor}}" required>
                          </div>
                        </div>
                        <div class="form-group row">
                ...
                <div class="card-body p-2 m-3" style="border: 1.5px solid #c3cad2">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <select id="app_bnd"name="app_bnd" class="form-control" style="border: 1px solid red;width: 100%;" required>
                ...
                <div class="card-footer">
                  <a href="/bendahara/pengajuan-kredit-anggota" type="button" class="btn btn-default ">Back</a>
  ...
  const input1 = document.getElementById('app_bnd');
