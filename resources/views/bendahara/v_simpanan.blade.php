          ...
          @if (session('sukses'))
            ...
            <div class="card">
                <div class="card-header bg-navy" >
                    <h3 class="card-title"><b style="font-size: 30px">S</b>IMPANAN ANGGOTA </h3><br>
                    ...
                    <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$no++}}</td>
                                <td>{{$data->name}}</td>
                                <td>KTP.{{$data->nikKtp}}</td>
                                <td>{{$data->nik_kry}}</td>
                                <td>{{$data->alamat}}</td>
                                <td >@currency($data->simpananMasuk-$data->simpananKeluar ? $data->simpananMasuk-$data->simpananKeluar : 0 )</td>
                                <td>
                                    <a href="/bendahara/detail-simpanan-anggota/{{$data->nikKtp}}" class="btn btn-primary btn-sm " style="border-radius: 5px">Lihat</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
