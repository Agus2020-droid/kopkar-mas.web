...
<head>
  ...
  <title>Cetak Akad Pembiayaan Motor</title>
...
<div class="wrapper">
  ...
  <section class="invoice">
    ...
    <div class="row invoice-info">
        ...
        <p style="font-size: 18px"><b><u>Nomor : {{$data->id_kredit}} / KMS-AKAD / SPDMTR / {{angkaRomawi(Carbon\Carbon::parse($data->tempo)->format("m"))}} /{{Carbon\Carbon::parse($data->tempo)->isoFormat("Y")}}
    </u> </b></p>
