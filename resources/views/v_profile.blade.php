      ...
      <div class="container">
        <div class="row">
          ...
          <div class="card card-widget widget-user">
            ...
            <div class="card-header bg-navy" style="border-bottom: 5px solid navy">
            <h3 class="card-title" ><strong>BIODATA DIRI</strong></h3><br>
            <hr class="mt-1 mb-0"style="border: 1px solid #fff">
          </div>
