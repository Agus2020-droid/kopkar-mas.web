      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card">
              ...
              <form class="form-horizontal" action="{{route('update.kredit.barang')}}" method="post">
                @csrf
                    ...
                    <div class="col-sm-6">
                      <div class="box p-2 m-1" >
                        <div class="form-group row ">
                          ...
                          <div class="col-sm-8">
                            <input id="tanpa-rupiah" name="nominal" type="text" class="form-control" value="@formatUang($data->nominal)" >
                          </div>
                        </div>
                        <div class="form-group row">
                          <label class="col-sm-4 col-form-label">Tenor<span class="text-red">*</span></label>
                          <div class="col-sm-8">
                              <input id="tenor" name="tenor" type="number" class="form-control" max="12" value="{{$data->tenor}}" >
                ...
                <div class="card-footer">
                  <a href="/petugas-barang/pengajuan-kredit-anggota" type="button" class="btn btn-default ">Back</a>
