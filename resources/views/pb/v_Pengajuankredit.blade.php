                    ...
                    <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/petugas-barang/approval-kredit/{{$data->id_kredit}}" class="btn btn-primary btn-sm <?php if($data->app_bnd == null) echo ''; else echo 'disabled';?>" style="border-radius: 5px"><i class="fas fa-edit"></i></a>
                      ...
                      <div class="col-sm-8">
                        <div class="form-group">
                          <select id="jns_krdt" name="jns_krdt" class="form-control" style="width: 100%;" required>
                            ...
                            <option value="KENDARAAN" class="d-none">KENDARAAN</option>
