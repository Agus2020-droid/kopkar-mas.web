      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card">
              ...
              <form class="form-horizontal" action="{{route('update.kredit.motor')}}" method="post">
                @csrf
                    ...
                    <div class="col-sm-6">
                      <div class="box p-2 m-1" >
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                              <input id="tenor" name="tenor" type="number" class="form-control" max="24" value="{{$data->tenor}}" >
                          </div>
                        </div>
                        <div class="form-group row">
