...
$(function () {
  ...
  var salesChart = new Chart($salesChart, {
    type: 'bar',
    data: {
      labels: ['JAN','FEB','MAR','APR','JUN', 'JUL', 'AGS', 'SEP', 'OKT', 'NOV', 'DES'],
      datasets: [
        {
          backgroundColor: '#007bff',
          borderColor: '#007bff',
          data: {!! json_encode($jumlahDataBarang) !!},
        },
        {
          backgroundColor: '#ced4da',
          borderColor: '#ced4da',
          data: {!! json_encode($jumlahDataMotor) !!},
        },
        {
          backgroundColor: '#d8b42b91',
          borderColor: '#d8b42b91',
          data: {!! json_encode($jumlahDataTunai) !!},
        }
      ]
    },
    options: {
