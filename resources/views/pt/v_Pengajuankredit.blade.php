                    ...
                    <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/petugas-tunai/approval-kredit/{{$data->id_kredit}}" class="btn btn-primary btn-sm <?php if($data->app_bnd == null) echo ''; else echo 'disabled';?>" style="border-radius: 5px"><i class="fas fa-edit"></i></a>
                                </td>
                                </td>
                            </tr>
                            @endforeach
